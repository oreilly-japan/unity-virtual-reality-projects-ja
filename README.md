...
※ 2018.2以降のバージョン以降のUnityには標準アセットが含まれなくなりました。2018.1以前のバージョンのUnityをお使いいただくか、もしくはAsset Storeにある[Standard Assets](https://assetstore.unity.com/packages/essentials/asset-packs/standard-assets-32351)をダウンロード、インポートしてください。
